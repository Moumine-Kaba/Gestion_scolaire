...
from src.modules.communication.announcements.controllers.actualite_controller import get_all_actualites, add_actualite, update_actualite, delete_actualite
