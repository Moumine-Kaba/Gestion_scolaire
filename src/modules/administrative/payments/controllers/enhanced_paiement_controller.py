...
class EnhancedPaiementController:
    ...
    def get_all_types_frais(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"ERREUR - Erreur récupération types de frais: {e}")
            return []
    ...
    def add_type_frais(self, nom: str, description: str, montant_standard: float, 
        ...
        try:
            ...
            conn.commit()
            conn.close()
            print(f"SUCCES - Type de frais '{nom}' ajouté avec succès")
            return True
            
        except Exception as e:
            print(f"ERREUR - Erreur ajout type de frais: {e}")
            return False
    ...
    def update_type_frais(self, type_frais_id: int, **kwargs) -> bool:
        ...
        try:
            ...
            if set_clauses:
                ...
                conn.commit()
                conn.close()
                print(f"SUCCES - Type de frais {type_frais_id} mis à jour")
                return True
            
            return False
            
        except Exception as e:
            print(f"ERREUR - Erreur mise à jour type de frais: {e}")
            return False
    ...
    def get_echeancier_eleve(self, eleve_id: int, annee_scolaire: str = None) -> List[Dict]:
        ...
        try:
            ...
            print(f"ERREUR - Erreur récupération échéancier: {e}")
            return []
    ...
    def get_echeances_en_retard(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"ERREUR - Erreur récupération échéances en retard: {e}")
            return []
    ...
    def generer_echeancier_eleve(self, eleve_id: int, annee_scolaire: str = None) -> bool:
        ...
        try:
            ...
            if cur.fetchone()[0] > 0:
                print(f"ATTENTION - Échéancier déjà existant pour l'élève {eleve_id}")
                conn.close()
                return False
            ...
            conn.commit()
            conn.close()
            print(f"SUCCES - {echeances_created} échéances générées pour l'élève {eleve_id}")
            return True
    ...
    def enregistrer_paiement_echeance(self, echeance_id: int, mode_paiement: str, 
        ...
        try:
            ...
            conn.commit()
            conn.close()
            print(f"SUCCES - Paiement enregistré pour l'échéance {echeance_id}")
            return True
            
        except Exception as e:
            print(f"ERREUR - Erreur enregistrement paiement: {e}")
            return False
    ...
    def get_remises_eleve(self, eleve_id: int) -> List[Dict]:
        ...
        try:
            ...
            print(f"ERREUR - Erreur récupération remises: {e}")
            return []
    ...
    def ajouter_remise(self, eleve_id: int, type_remise: str, motif: str,
        ...
        try:
            ...
            conn.commit()
            conn.close()
            print(f"SUCCES - Remise ajoutée pour l'élève {eleve_id}")
            return True
            
        except Exception as e:
            print(f"ERREUR - Erreur ajout remise: {e}")
            return False
    ...
    def get_statistiques_paiements(self, annee_scolaire: str = None) -> Dict:
        ...
        try:
            ...
            print(f"ERREUR - Erreur calcul statistiques: {e}")
            return {}
    ...
    def get_rapport_tresorerie(self, date_debut: str, date_fin: str) -> Dict:
        ...
        try:
            ...
            print(f"ERREUR - Erreur génération rapport trésorerie: {e}")
            return {}
    ...
    def calculer_penalites_retard(self, echeance_id: int) -> float:
        ...
        try:
            ...
            print(f"ERREUR - Erreur calcul pénalités: {e}")
            return 0
    ...
    def appliquer_penalites_retard(self) -> int:
        ...
        try:
            ...
            print(f"SUCCES - {penalites_appliquees} pénalités appliquées")
            return penalites_appliquees
            
        except Exception as e:
            print(f"ERREUR - Erreur application pénalités: {e}")
            return 0
...
def get_all_paiements_enhanced(eleve_id=None):
    ...
    try:
        ...
        print(f"ERREUR - Erreur récupération paiements: {e}")
        return []
