...
# -*- coding: utf-8 -*-
"""
Script pour ajouter 20 cours de test directement
"""
...
def add_courses_directly():
    """Ajoute 20 cours directement avec des données fictives"""
    ...
    try:
        with sqlite3.connect(db_path) as conn:
            ...
            # Créer la table enseignement si elle n'existe pas
            cursor.execute("""
            ...
            # Créer la table emplois_du_temps si elle n'existe pas
            cursor.execute("""
            ...
            for i, (prof_id, classe_id, matiere_id, salle_id, jour, duree, statut) in enumerate(cours_data):
                cursor.execute("""
            ...
            # Données fictives pour les emplois du temps
            emplois_data = [
